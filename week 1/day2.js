...
//   - Discards everything before and including the first 'c'
//   - Removes all the occurrences of the text 'Eek!'
//   - Reverses the resulting String
//   - Splits the string, using the 'v' char
//   - Returns an array with the first character of each resulting string, starting from the second element on the array.
